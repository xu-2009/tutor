...
const STRINGS = {
  ...
  heroSub: {
    en: 'Free honors-level courses in Math, Physics, Chemistry, Biology and English — plus AP Calculus AB & BC. Learn a lesson, practice right away, and your progress is always saved.',
    zh: '免费的高中荣誉级课程：数学、物理、化学、生物、英语，外加 AP 微积分 AB 和 BC。学完一课立刻练习，学习进度自动保存。',
  },
  ...
  footer: { en: 'ScholarPath — free honors & AP courses for high school students.', zh: 'ScholarPath 学径 — 为高中生提供免费荣誉与 AP 课程。' },
}
